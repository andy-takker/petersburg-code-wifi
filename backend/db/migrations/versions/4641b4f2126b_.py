...
def upgrade() -> None:
    ...
    op.create_table('district', sa.Column('id',
                                          sa.BigInteger(),
                                          nullable=False),
                    sa.Column('name', sa.String(length=255), nullable=False),
                    sa.PrimaryKeyConstraint('id'))
    op.create_index(op.f('ix_district_id'), 'district', ['id'], unique=False)
    op.create_index(op.f('ix_district_name'),
                    'district', ['name'],
                    unique=False)
    op.create_table(
        'wifi_zone', sa.Column('id', sa.BigInteger(), nullable=False),
    ...
    op.create_index(op.f('ix_wifi_zone_district_id'),
                    'wifi_zone', ['district_id'],
                    unique=False)
    op.create_index(op.f('ix_wifi_zone_id'), 'wifi_zone', ['id'], unique=False)
    op.create_index(op.f('ix_wifi_zone_latitude'),
                    'wifi_zone', ['latitude'],
                    unique=False)
    op.create_index(op.f('ix_wifi_zone_longitude'),
                    'wifi_zone', ['longitude'],
                    unique=False)
    ...
    op.create_table('celery_periodic_task',
                    ...
                    sa.Column('exchange', sa.String(length=255),
                              nullable=True),
                    sa.Column('routing_key',
