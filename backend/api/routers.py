...
async def get_wifi_zones(
    limit: int, offset: int, wifi_zone: WifiZoneRepo = Depends()) -> Any:
...
async def get_nearest_wifi_zones(
    limit: int,
    offset: int,
    latitude: float,
    longitude: float,
    ...
    return wifi_zone.get_nearest_wifi_zones(limit=limit,
                                            offset=offset,
                                            lat_x=latitude,
                                            lon_x=longitude,
                                            radius=radius)
